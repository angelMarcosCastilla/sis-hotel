          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr class="table__body-row" v-for="habitacion in habitacionesFiltradas" :key="habitacion.num">
                ...
                <td class="table__body-cell">{{habitacion.numpiso}}</td>
              ...
              <div>
                ...
                <form @submit.prevent="registerOrEditHabitacion">
                  <div class="mb-3">
                    ...
                    <input type="number" name="numHabitacion"
                      :value="habitacionEditar ? habitacionEditar.idhabitacion : ''">
                  </div>
                  <div class="flex mb-3">
                    <div style="flex:1">
                      <label for="piso">Piso</label>
                      <select name="piso" :value="habitacionEditar ? habitacionEditar.numpiso : 1">
                        <option value="1">Primer piso</option>
                        <option value="2">Segundo piso</option>
                        <option value="3">Tercer piso</option>
                        <option value="4">Cuarto piso</option>
                    ...
                    <div style="flex:1">
                      ...
                      <select name="tipoHabitacion"
                        :value="habitacionEditar ? habitacionEditar.idtipohabitacion : tiposHabitaciones[0]?.idtipohabitacion">
                        <option v-for="tipo in tiposHabitaciones" :key="tipo.idtipohabitacion"
                          :value="tipo.idtipohabitacion">{{tipo.nombre}}</option>
                      </select>
                    </div>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea name="detalles" id="" cols="30" rows="3"
                      :value="habitacionEditar ? habitacionEditar.detalles : ''"></textarea>
                  </div>
                  <button>
